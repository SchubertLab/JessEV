...
from spacers.variable_length.constraints import VariableLengthVaccineConstraint
from spacers.variable_length.objectives import VariableLengthVaccineObjective


class VariableLength(ModelImplementation):
    '''
    ...
    def __init__(
            self,
            params: ModelParams,
            vaccine_constraints: List[VariableLengthVaccineConstraint],
            vaccine_objective: VariableLengthVaccineObjective
    ):

        super(VariableLength, self).__init__(params, vaccine_constraints, vaccine_objective)
